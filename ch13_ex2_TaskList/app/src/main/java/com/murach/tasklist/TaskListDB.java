    ...
    private static class DBHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL("INSERT INTO task VALUES (2, 1, 'Get hair cut', " +
                    "'', '0', '0')");
            // added this line because i cannot access the db in the data folder on
            // my phone from some reason
            // I have commented it out after running it once to prevent multiple
            // inserts.
            //db.execSQL("INSERT INTO task VALUES (100, 1, 'TEST!', '', '0', '0')");
        }
